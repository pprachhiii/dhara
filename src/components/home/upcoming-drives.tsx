      ...
      <div className='container mx-auto px-4'>
        ...
        <div className='mb-8 flex items-center justify-between'>
          <div>
            ...
            <p className='text-muted-foreground'>Community actions scheduled ahead</p>
          </div>
        ...
        {/* Content */}
        {drives.length === 0 ? (
          <p className='text-center text-muted-foreground'>No upcoming drives yet. Stay tuned!</p>
        ) : (
